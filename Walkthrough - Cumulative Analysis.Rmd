...
d2 <- data.frame(read.csv("Walkthrough.2016.07.28.csv"),
                 Date = "2016-07-28")
d3 <- data.frame(read.csv("Walkthrough.2016.07.28.csv"), 
                 Date = "2016-11-17")
...
For some reason the scale is not working on this graph (sorry!). The horizontal axis starts in Feb 2016 and finishing Jul 2016.
