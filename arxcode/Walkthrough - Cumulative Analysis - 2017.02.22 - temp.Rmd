...
Walkthroughs conducted from early 2016 to `r Sys.Date()`. The following questions were data was collected from each class:
...
d <- data.frame(suppressMessages(read_csv("Walkthrough.2017.02.22.csv")), 
                 Date = "2017-02-22")

wtd_today <- d
names(wtd_today) <- c('period','room','year.level','number.of.students','lesson.time','direct.instruction','discussing','reading..viewing','groupwork','independent.work','LI.visible','SC.visible','learning.understanding','success.understanding','date')
```
...
d0 <- data.frame(suppressMessages(read_csv("Walkthrough.2016.02.10.csv")), 
                 Date = "2016-02-10")
d1 <- data.frame(suppressMessages(read_csv("Walkthrough.2016.06.08.csv")),
                 Date = "2016-06-08")
d2 <- data.frame(suppressMessages(read_csv("Walkthrough.2016.07.28.csv")),
                 Date = "2016-07-28")
d3 <- data.frame(suppressMessages(read_csv("Walkthrough.2016.11.17.csv")), 
                 Date = "2016-11-17")
d4 <- data.frame(suppressMessages(read_csv("Walkthrough.2017.02.22.csv")), 
                 Date = "2017-02-22")
